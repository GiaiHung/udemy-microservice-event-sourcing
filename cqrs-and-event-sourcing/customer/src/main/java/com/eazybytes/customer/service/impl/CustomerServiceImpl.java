...
public class CustomerServiceImpl implements ICustomerService {
    ...
    @Override
    public boolean updateCustomer(Customer customerEvent) {
        Customer customer = customerRepository.findByMobileNumberAndActiveSw(customerEvent.getMobileNumber(), true)
                .orElseThrow(() -> new ResourceNotFoundException("Customer", "mobileNumber", customerEvent.getMobileNumber()));
        CustomerMapper.mapEventToCustomer(customerEvent, customer);
